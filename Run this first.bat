...
echo. >>"%SystemRoot%\system32\drivers\etc\hosts"
echo 0.0.0.0 arcade-events-api.output.com>>"%SystemRoot%\system32\drivers\etc\hosts"
echo 0.0.0.0 api.output.com>>"%SystemRoot%\system32\drivers\etc\hosts"
echo # >>"%SystemRoot%\system32\drivers\etc\hosts"
cd C:\ProgramData\Output\Arcade\
del /f /q api-user.xml
msg * ok! now go to part 2
exit
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
